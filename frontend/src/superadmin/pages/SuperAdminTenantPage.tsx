...
export function SuperAdminTenantPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="neo-card p-6">
        ...
        <div className="mt-4 flex flex-col gap-3 sm:flex-row">
          <NeumorphicButton variant="primary" onClick={() => router.push('/superadmin/tenant/add')}>
            Add tenant
          </NeumorphicButton>
          <NeumorphicButton onClick={() => router.push('/superadmin/tenant/view')}>
            View tenant
          </NeumorphicButton>
        </div>
      </div>
