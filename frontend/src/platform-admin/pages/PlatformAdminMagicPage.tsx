...
export function PlatformAdminMagicPage() {
  useAuthDocumentTitle('platform-admin', 'Magic link');
    ...
    platformAdminApi
      ...
      .then(({ data }) => {
        ...
        if (data.onboardingCompleted) {
          ...
          router.replace(`/platform-admin/auth/onboarding?sessionId=${data.sessionId}`);
        }
      })
      .catch((e: unknown) => {
